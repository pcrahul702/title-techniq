  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4">
        <div className="bg-black opacity-60 py-2 text-white text-center   font-league-spartan text-[40px] font-normal  uppercase leading-[150%]">
        ...
        <div className='flex  justify-center gap-6 mt-[72px]'>
          ...
          <button className="w-[157px] bg-black opacity-70  px-5 py-4 text-center border-white border text-white  rounded-lg text-base font-semibold mr-2">Get Started<Image src={Leftarrow} alt="Left Arrow" width={16} height={16} /></button>
        </div>
      </div>
    </div>
  );
